%
% Pseudo-sprectral time domain method object 2d
% 
%
% Made by S Durbridge
%
...
classdef sedea_pstd_2d
    properties
        ...
        rho %Fluid density
        c %Speed of sound
        diffMatx %Spectral difference matrix for x
        diffMaty %Spectral difference matrix for y
        
        %Domain Properties
        xLength %Length of domain in x direction
        yLength %Length of domain in y direction
        xArraySize %Size of the base arrays in the x direction
        yArraySize %Size of the base arrays in the y direction
        numSolids %Number of solids used to define domain shape
        solidType %The type of each solid, listed in order
        boundaryType
    ...
    methods
        function obj = sedea_pstd_2d(fs, xLength, yLength)
            obj.fs = fs;
            obj.xLength = xLength;
            obj.yLength = yLength;
        end
